...
public class DeletePasswordSecretPage
{
	WebDriver fdriver;
	public DeletePasswordSecretPage(WebDriver gdriver)
	{
		fdriver=gdriver;
	...
	// WebElement ClickSecrets;
	 ...
	 @FindBy(xpath="//*[@id=\"app\"]/div/div/div[2]/main/div/div[2]/div[2]/div/div/div/button[3]")
	 @CacheLookup
	 WebElement Delete;
