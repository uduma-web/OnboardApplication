...
public class AddingProjectToGroupPage
{
	WebDriver fdriver;
	public AddingProjectToGroupPage(WebDriver jdriver)
	{
		fdriver=jdriver;
	...
	@FindBy(xpath="//*[@id=\"app\"]/div/div/div[2]/main/div/div[3]/div[1]/nav/a[3]")
	@CacheLookup
	WebElement Projects;
	...
	@FindBy(xpath="//*[@id=\"app\"]/div/div/div[2]/main/div/div[3]/div[2]/div/div/div/div[2]/div/ul/li[1]/div/div/div/div[3]/span/button")
	@CacheLookup
	...
	public void AddingFirstProject()
	{
